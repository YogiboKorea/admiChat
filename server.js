...
// =========================================================================
// [1회성 일회용 API] 룰렛 누락자 일괄 DB 삽입 
// (실행 완료 후 보안을 위해 주석 처리하거나 삭제하세요)
// =========================================================================
app.get('/api/raffle/admin/fix-missing', async (req, res) => {
  try {
    const targetUserId = '5051348@n';
    const rolletCollection = db.collection(ROLLET_COLLECTION);

    // 1. 기준이 되는 아이디의 Document를 찾습니다.
    const targetUser = await rolletCollection.findOne({ userId: targetUserId });

    if (!targetUser) {
      return res.status(404).json({ success: false, message: '기준 아이디를 찾을 수 없습니다.' });
    }

    // 2. 관리자 페이지는 createdAt 역순(최신순) 정렬이므로, 
    // 기준점보다 시간이 미세하게 '미래'여야 목록에서 위에 노출됩니다.
    const baseTimeMs = new Date(targetUser.createdAt).getTime();

    // 이미지에서 추출한 누락된 아이디 리스트
    const missingIds = [
      "4828234140@k", "sy130522", "tprl28", "4828241514@k", "14945241@n", "4207446758@k", "50454337@n", "13000382@n", "4828246268@k", "12637471@n",
      "4828245476@k", "19462336@n", "53956809@n", "55452041@n", "4828249619@k", "4828250814@k", "4828247255@k", "93693551@n", "4828253824@k", "4828254492@k",
      "118904994@n", "4828252247@k", "4828255039@k", "56503369@n", "4828256927@k", "4828260924@k", "4828261034@k", "12157637@n", "4828262409@k", "4828261716@k",
      "21217049@n", "4828262333@k", "e1104", "62434184@n", "4828264553@k", "29090634@n", "65480950@n", "4828266703@k", "33489063@n", "4828268146@k",
      "4828268705@k", "4828268340@k", "150682330@n", "4828274535@k", "4828275736@k", "4828276523@k", "4828272806@k", "4828283142@k", "50427003@n", "4828266638@k",
      "4828296911@k", "3339587@n", "4828318753@k", "4828325422@k", "4828450589@k", "4828278164@k", "39308234@n", "36496376@n", "4828459858@k", "64449140@n",
      "65348163@n", "4828455570@k", "4828458659@k", "4828451000@k", "4828457472@k", "135831954@n", "yeong4039", "129924193@n", "4828469540@k", "4828469598@k",
      "rlrlfk12", "4828458109@k", "95191527@n", "4828471096@k", "4828476710@k", "4828476425@k", "4828479218@k", "4828479972@k", "thebabycodnj", "4828479953@k",
      "4828483301@k", "53249059@n", "4828485339@k", "4828485580@k", "45752770@n", "4828489866@k", "65031183@n", "4828490323@k", "4828490403@k", "4828490050@k",
      "4828491842@k", "4828492557@k", "4828495436@k", "4828494653@k", "4828497563@k", "4828499179@k", "4828499512@k", "4828501341@k", "4828501551@k", "4818916881@k",
      "4828505434@k", "4698472@n", "4828506756@k", "4828507681@k", "37015385@n", "4828510131@k", "4828510735@k", "4828511575@k", "4828511776@k", "4828509873@k",
      "32265818@n", "4828513085@k", "4828512374@k", "183960119@n", "4828513736@k", "4828512242@k", "4828515416@k", "4828516354@k", "4828518621@k", "4828518800@k",
      "4828521249@k", "39012081@n", "37521319@n", "4828524588@k", "34126763@n", "4828525532@k", "4828526871@k", "4828527407@k", "4828527616@k", "4828532472@k",
      "4828532555@k", "4828532899@k", "4828533422@k", "4828534829@k", "4828534805@k", "4828535025@k", "4828535923@k", "4828538804@k", "4828538986@k", "4828540696@k",
      "4828538252@k", "4828542044@k", "4828540039@k", "bubu911", "4828543115@k", "4828542979@k", "4828541532@k", "4828543406@k", "4828543538@k", "4828543962@k",
      "4828544793@k", "4828545372@k", "4828550557@k", "4828553496@k", "4828553521@k", "chsh1216", "4828551885@k", "4828556689@k", "4828557832@k", "4828557572@k",
      "js0721", "4828559466@k", "4828561975@k", "4828562823@k", "4828562562@k", "4828564133@k", "4828565341@k", "4828565652@k", "4828564913@k", "4828565327@k",
      "4828566741@k", "4828567870@k", "4828567094@k", "4828567969@k", "4828569454@k", "4828569452@k", "4828569488@k", "4828570364@k", "4828570972@k", "4828560733@k",
      "4210317716@k", "4828573200@k", "4828573967@k", "4828573344@k", "4828574589@k", "4828575399@k", "4828577234@k", "4828578998@k", "4828579610@k", "4828579129@k",
      "4828581229@k", "4828581677@k", "4828585094@k", "4828587132@k", "4828587172@k", "4828587842@k", "4828589244@k", "4828591089@k", "4828594020@k", "4828598807@k"
    ];

    // 3. 삽입할 데이터 객체 매핑
    const docsToInsert = missingIds.map((id, index) => {
      // 배열의 앞쪽(인덱스가 낮을수록)이 더 위에 노출되어야 하므로, 
      // 타겟 시간에서 전체 길이에 비례해 밀리초를 더해줍니다.
      const timeOffset = missingIds.length - index;
      const adjustedDate = new Date(baseTimeMs + timeOffset);

      return {
        userId: id,
        optionName: "복구_누락데이터", // 필요 시 실제 응모했던 경품명으로 일괄 변경하세요.
        entryDate: targetUser.entryDate, // 타겟 유저의 응모일과 맞춥니다.
        createdAt: adjustedDate
      };
    });

    // 4. DB에 Bulk Insert 실행
    await rolletCollection.insertMany(docsToInsert);

    res.json({ success: true, message: `${missingIds.length}건 누락 데이터 복구 완료!` });

  } catch (error) {
    console.error('누락 데이터 복구 에러:', error);
    res.status(500).json({ success: false, error: error.message });
  }
});

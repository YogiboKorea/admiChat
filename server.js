...
async function updateMarketingPurposeConsent(memberId) {
  ...
  // 실제 응답 필드 이름은 privacy_consents 입니다.
  const consents = listRes.privacy_consents || [];

  // 1-b) “marketing” 타입이 이미 있으면 seq 뽑아서 PUT
